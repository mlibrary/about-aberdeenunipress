        ...
        <div className="row justify-content-between">
          <section className="col-md-6 contact">
            <a href="/" className="logo navigo">
              <img src="/assets/aberdeen.svg" height="75px" width="auto" alt="Aberdeen University Press" />
            </a>
            ...
            <span className="d-block pt-2">
              <a className="twitter pr-2" href="https://twitter.com/AbdnUniPress"><svg height="16px" width="auto" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg"><title>X</title>
