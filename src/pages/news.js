        ...
        <div className="row text-right">
          <div className="col-md-12">
            <p className="social navigo">Connect with us  
              <a href="https://twitter.com/AbdnUniPress"><svg className="tw" width="1200" height="1227" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg"><title>X</title>
